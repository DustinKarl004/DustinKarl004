...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0A0A0A,50:145A32,100:14213D&height=230&section=header&text=DUSTINKARL.DEV&fontSize=54&fontColor=FFFFFF&animation=fadeIn&fontAlignY=38&desc=%2F%2F%20FULL%20STACK%20WEB%20DEVELOPER&descAlignY=62&descSize=17&descColor=CFEFE0" width="100%"/>
...
### 🏪 Z.A. Company
`Vue.js` `Python` `PostgreSQL` `Railway` `Vercel`
- Inventory & sales management for branch operations
- Daily stock, sales, and profit tracking per branch

[`→ live`](https://z-a-company.vercel.app)
...
### ⚔️ GenshinHub
`React` `JavaScript`
- Fan-made Genshin Impact hub
- Character guides, build recs, tier lists
...
### 💼 JobZing
`Django` `Vue.js` `PostgreSQL` `Celery` `Brevo`
- Job board for Filipino remote workers, scraped from OnlineJobs.ph
- Resume builder, cover letter generator, application tracking
...
### 🩻 AU Medico Legal IME
`Python` `Pandas`
- Scraper consolidating IME data from AU medico-legal sites
- Specialties, locations, accreditations → Excel/CSV output
...
`React` `JavaScript`
- This portfolio — React + Vite, glassmorphism, dark/light mode
- CSS-only animations, mock UI previews per project
...
### 🕰️ Personal Portfolio v1
`Bootstrap` `JavaScript`
- First portfolio site — glassmorphism, dark/light toggle
...
### 📘 Full Stack Tutorial
`Next.js` `React`
- Educational platform with step-by-step dev tutorials
...
### 🧠 Interactive Quiz
`JavaScript`
- Quiz app with score tracking & instant feedback
...
- Company site: services, team, contact
...
- Normalize, dedupe, upload to BigQuery
...
- Loan calculator: monthly payments, interest, schedules
- Django REST backend
